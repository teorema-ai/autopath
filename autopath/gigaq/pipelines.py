...
# 
# git commit -am "gigaq: FeaturebagsetDataloader: SAMPLES"; dbx.print "autopath.gigaq.pipelines.gigapath_featurebagset_dataloader_samples('GIGAPATH_BASELINE_CPTAC_8020_TRAIN', 400, , root='/mnt/labshare/PERSONAL/dmitry/datalake', batch_size=4, num_workers=4, prefetch_factor=1)" 
