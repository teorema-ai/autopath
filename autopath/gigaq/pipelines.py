...
# git commit -am 'gigaq: FeaturePairwiseDistances: BUILD'; dbx.print 'autopath.gigaq.pipelines.gigapath_feature_pairwise_distances("GIGAPATH_BASELINE_5BLOCK0_CPTAC_9802_TEST_10_1000_74000").set(n_devices=3).build_tree()'
def gigapath_feature_pairwise_distances(name) -> FeaturePairwiseDistances:
    ...
    elif name == "GIGAPATH_BASELINE_5BLOCK0_CPTAC_9802_TEST_10_1000_74000":
        return FeaturePairwiseDistances(
